export const personal = {
  ...
  bio: [
    'My doctoral research at Alabama A&M University addresses a fundamental question in crop protection: how do cotton (Gossypium hirsutum) genotypes respond to reniform nematode (Rotylenchulus reniformis) infestation at the molecular level? By integrating whole-transcriptome RNA-seq, rhizosphere 16S/ITS amplicon sequencing, and functional pathway analysis, I characterize the gene networks and microbial community dynamics that distinguish susceptible from tolerant genotypes — work aimed at identifying candidate defense genes and microbiome bioindicators for sustainable nematode management.',
    'My M.S. research established a rigorous foundation in controlled-environment plant physiology, examining how atmospheric pressure plasma applied to seeds and irrigation water affects germination, seedling vigor, yield, and drought tolerance in microgreen crops. That work yielded peer-reviewed publications on low-temperature plasma as an emerging green technology for crop improvement, and developed my proficiency in experimental design, SAS/R statistical analysis, and molecular biology methods.',
  ],
